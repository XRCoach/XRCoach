...
public class MadgwickAHRS
{
    ...
    public MadgwickAHRS(float beta, float samplePeriod)
    {
        this.beta = beta;
    ...
    {
        // Implementation with magnetometer (similar structure but longer)
        // Full magnetometer implementation available on request
        Update(gx, gy, gz, ax, ay, az); // Fallback to 6DOF for brevity
    }
}